...
<body>
    ...
    <div>
        <h2>
            <a href="ejercicios/jercicio1.php">Ejercicio 1</a>
        </h2>
    ...
    <div>
        <h2>
            <a href="ejercicios/ejercicio2.php">Ejercicio 2</a>
        </h2>
    ...
    <div>
        <h2>
            <a href="ejercicios/ejercicio3.php">Ejercicio 3</a>
        </h2>
    ...
    <div>
        <h2>
            <a href="ejercicios/ejercicio4.php">Ejercicio 4</a>
        </h2>
    ...
    <div>
        <h2>
            <a href="ejercicios/ejercicio5.php">Ejercicio 5</a>
        </h2>
    ...
    <div>
        <h2><a href="ejercicios/ejercicio6.php">Ejercicio 6</a>
        </h2>
    ...
    <div>
        <h2><a href="ejercicios/ejercicio7_videojuegos.php">Ejercicio 7 - Formulario de elegir consolas.</a>
        </h2>
        <p>
    ...
    <div>
            <h2><a href="ejercicios/ejercicio_prueba.php">Formulario con respuesta misma pagina.</a>
            </h2>
